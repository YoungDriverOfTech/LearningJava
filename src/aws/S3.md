...
## Hands on
![img.png](s3/img.png)
![img_1.png](s3/img_1.png)
![img_2.png](s3/img_2.png)
![img_3.png](s3/img_3.png)
![img_4.png](s3/img_4.png)
...
![img_5.png](s3/img_5.png)

### User Access to S3 - IAM permissions
![img_6.png](s3/img_6.png)

### EC2 Access to S3 - Role
![img_7.png](s3/img_7.png)

### Cross-Account Access - Use Bucket Policy
![img_8.png](s3/img_8.png)

### Bucket settings Block Public Access 
![img_9.png](s3/img_9.png)
- 这些设定是用来防止公司数据泄漏
- 如果知道数据绝不是公开的，那么就开启这些设定
- 可以在账户级别设置

### 开放bucket给public
![img_10.png](s3/img_10.png)
![img_11.png](s3/img_11.png)
![img_12.png](s3/img_12.png)
![img_13.png](s3/img_13.png)
![img_14.png](s3/img_14.png)

## S3挂载静态网页
![img_15.png](s3/img_15.png)
![img_16.png](s3/img_16.png)
![img_17.png](s3/img_17.png)
![img_18.png](s3/img_18.png)
![img_19.png](s3/img_19.png)
...
- 注意
  ...
  - 暂停版本控制不会删除以前的版本
![img_20.png](s3/img_20.png)

### hands on
![img_21.png](s3/img_21.png)
![img_22.png](s3/img_22.png)
![img_23.png](s3/img_23.png)
![img_24.png](s3/img_24.png)
...
### hands on
![img_25.png](s3/img_25.png)
![img_26.png](s3/img_26.png)
![img_27.png](s3/img_27.png)
![img_28.png](s3/img_28.png)
...
### 对比
![img_29.png](s3/img_29.png)
![img_30.png](s3/img_30.png)


### hands on

![img_31.png](s3/img_31.png)
![img_32.png](s3/img_32.png)
![img_33.png](s3/img_33.png)
![img_34.png](s3/img_34.png)
![img_35.png](s3/img_35.png)
![img_36.png](s3/img_36.png)
...
### hands on
![img_38.png](s3/img_38.png)
![img_39.png](s3/img_39.png)
...
![img_41.png](s3/img_41.png)

### s3向外部推送消息
需要接受消息的一样设置权限，能够接受s3推送过来的消息
![img_42.png](s3/img_42.png)

### EventBridge 监听s3的所有事件
- 更高级的过滤器：可以使用JSON规则（metadata，object size，name）
- 多个推送目的地
![img_43.png](s3/img_43.png)

### Practice 推送消息到SQS队列
![img_44.png](s3/img_44.png)
![img_45.png](s3/img_45.png)
![img_46.png](s3/img_46.png)
![img_47.png](s3/img_47.png)
![img_48.png](s3/img_48.png)
![img_49.png](s3/img_49.png)
![img_50.png](s3/img_50.png)
![img_51.png](s3/img_51.png)
![img_52.png](s3/img_52.png)
![img_53.png](s3/img_53.png)
![img_54.png](s3/img_54.png)
...
![img_66.png](s3/img_66.png)

### hands on
![img_67.png](s3/img_67.png)
![img_68.png](s3/img_68.png)
...
### 图解
![img_70.png](s3/img_70.png)

### S3-CORS
- 如果客户端发送了一个跨域请求到s3，我们需要启用正确的cors请求头
- 考试常考
- 可以允许所有的或者特定的源来访问s3
![img_71.png](s3/img_71.png)

### Hands on
![img_72.png](s3/img_72.png)
...
![img_74.png](s3/img_74.png)

### Hands on
![img_75.png](s3/img_75.png)
...
### hands on
![img_76.png](s3/img_76.png)

## S3 Glacier Vault Lock
### 概念
- 采用WORM模式（Write Once Read Many）
- 穿件一个Vault Lock Policy
- Lock住未来的修改（不能被修改或者删除）
- 有助于合规性和数据保留

### S3 object lock（必须启动版本控制）
- WORM模式
- 锁住一个指定的object版本一段时间，不能被删除
- Retention Mode（保留策略）
  - Compliance
    - object 版本不能被覆盖或者删除，甚至root用户也不行
    - retention mode不能被修改，retention期间也不能被缩短
  - Governance
    - 多数用户不能修改和删除object version或者修改锁设定
    - 一些用户有权限修改或删除object
  - Retention Period
    - 保护object在一定时间内不被修改删除，这个时间可以演唱
  - Legal Hold
    - 无限的保护object
    - 可以被自由的防止和易走，如果IAM拥有s3:PutObjectLegalHold权限

## Access Points 访问端点
![img_77.png](s3/img_77.png)
- Access Points简化了s3的安全管理
- 每一个Access Points拥有
  - 自己的DNS名字
  - 一个access point policy（类似于bucket policy）--大规模管理安全性

![img_78.png](s3/img_78.png)
![img_79.png](s3/img_79.png)

## Object Lambda
- 使用AWS Lambda函数，可以在call app访问这些object的时候之前，修改他们
- 只有一个bucket，除此之外还需要创建s3 access point和Lambda access point
- 使用case
  - 转换格式，比如xml to json
  - 裁剪照片
![img_80.png](s3/img_80.png)